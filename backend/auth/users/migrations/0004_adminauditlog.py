...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_registrationotpchallenge'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['action', 'created_at'], name='users_admina_action_015f9d_idx'),
                    models.Index(fields=['target_type', 'target_id'], name='users_admina_target__31fc62_idx'),
                ],
            },
        ),
    ]
